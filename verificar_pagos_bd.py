...
Ejecutar con: python manage.py shell < verificar_pagos_bd.py
O desde shell de Django: exec(open('verificar_pagos_bd.py').read())
"""
import os
import sys

# Si no está en el shell de Django, intentar configurarlo
try:
...
def verificar_pagos():
    ...
    if transacciones_antiguas.exists():
        for trans in transacciones_antiguas[:10]:  # Mostrar solo las primeras 10
    ...
    if total_inconsistencias == 0:
        ...
        print("  python corregir_pagos_bd.py")
